...
<div style="width:265px;height:100px;border:solid 1px #e7d8d8; float:left; margin-top:10px; margin-left:4px;">
	...
	<div style="background: transparent url(<?php echo $img_name;?>) no-repeat scroll center center; -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous;" class="itemImg">
		<a href="<?='tin-rao/'.$ci_properties['property_type'].'/'.$ci_properties['id']?>/<?=$ci_properties['name_sef']?>" class="itemTitle" id="vip1796432">
			<img height="88" border="0" width="88" src="<?=base_url()?>images/spacer.gif" title="Xem ảnh">
		</a>
	</div>
 </div>
 <div style="width:125px;height:90px;float:left;margin-left:4px;margin-top:3px;">
