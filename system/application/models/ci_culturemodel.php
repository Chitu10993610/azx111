<?
class Ci_cultureModel extends Model {
/**
 * MODULE NAME   : ci_culturemodel.php
 *
 * DESCRIPTION   : Ci_culture model controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2009-03-17 06:23 PM   - Pradesh Chanderpaul     - Created
 *
 * @package             ci_culture
 * @subpackage          Ci_culture model component Class
...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db->count_all( 'culture' );
      ...
      $sql = 'SELECT * FROM '.$this->db->dbprefix('culture'). $where_clause . $limit_clause;
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['culture']		 = $row['culture'];
   ...
   function retrieve_by_pkey($idField) {
      ...
      $query = $this->db->query("SELECT * FROM ".$this->db-dbprefix."culture WHERE id = '$idField' LIMIT 1");
   ...
   function add( $data ) {
      ...
      $sql = $this->db->insert_string('culture', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      // Build up the SQL query string
      $where = "id = $keyvalue";
      $sql = $this->db->update_string('culture', $data, $where);
   ...
   function delete_by_pkey($idField)
   {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $query = $this->db->query("DELETE FROM ci_culture WHERE id = '$idField' ");
   ...
   function delete_all()
   {
      // Load  the db library
      $this->load->database();
      $query = $this->db->query("DELETE FROM ".$this->db->dbprefix."culture");
