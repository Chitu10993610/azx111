...
/*<![CDATA[*/
	...
	if(window.opener) {
		I18N = window.opener.document.ImageManager.I18N;
	}
...
<? } ?>
	...
	<iframe src="images.php?f=<?=$_GET['f']?>" name="imgManager" id="imgManager" class="imageFrame" scrolling="auto" title="Image Selection" frameborder="0"></iframe>
</div>
</fieldset>
<!-- image properties -->
