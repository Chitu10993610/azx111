...
<td valign="top">
	...
	<tr>
		...
		<font color="#FFFFFF"><b>&nbsp; Thêm danh mục mới</b></font></td>
	</tr>
	<tr>
					...
					(cho phép hiển thị ngoài website hay không)</span></td>
                                        ...
                                        <tr> 
                                          ...
                                          <td>
                                            ...
                                            <input name="btnView" type="button" class="button" value="Xem DS" onClick="document.location.href='<?=base_url()?>cat'"></td>
                                        </tr>                                        
                                      </form>
                                      </table>
			 </td>
