...
class Cat extends Controller {
   ...
   */
   ...
   // //////////////////////////////////////////////////////////////////////////
   function browse() {
   	$this->user_group_model->can_access(VIEW_LIST_CATEGORY_ADS, null, null);
...
//      $catId = $this->uri->segment(3,0);
   ...
   // //////////////////////////////////////////////////////////////////////////
   function add() {
		$this->user_group_model->can_access(ADD_CATEGORY_ADS, null, null);
   ...
   // //////////////////////////////////////////////////////////////////////////
   function modify() {
	$this->user_group_model->can_access(EDIT_CATEGORY_ADS, null, null);
      $submit = $this->input->post('Submit');
      $this->load->model('nny_catmodel');
      $catId = $this->uri->segment(3,0);
