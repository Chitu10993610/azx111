...
*/
$base_dir = $_SESSION['base_dir'] ? $_SESSION['base_dir'] : 'news';
$IMConfig['base_dir'] = dirname(dirname(__FILE__)).'/images/'.$base_dir;
...
*/
$IMConfig['base_url'] = 'http://tapchiphunu.net/images/'.$base_dir;
